...
/**
 * Injects GA4, Meta (Facebook) Pixel and TikTok Pixel — each only when its
 * env var is set, so nothing loads until you paste in the IDs. PageView fires
 * automatically; purchase events are sent from <PurchaseTracker/>.
 */
